...
setwd('/home/vmuser/Desktop/PHC6194SPR2021/WK8')
...
#run SatScan
datsatscan <- satscan(td, "dat",sslocation = "/usr/local/SaTScan",ssbatchfilename = "SaTScanBatch64")
...
#run SatScan
sidssatscan <- satscan(td, "sids",sslocation = "/usr/local/SaTScan",ssbatchfilename = "SaTScanBatch64")
